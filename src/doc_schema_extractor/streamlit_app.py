...
Features:
- Upload PDF or XLSX
- Choose Ollama or OpenAI backend + model
- Run extraction (shows template ID, match score, LLM used flag)
- Inspect extracted JSON + run metadata
- Chat over the extracted data using the document as context
- All extraction runs and chat turns traced in LangSmith
"""
